        ...
        <section className="py-10 px-10 shadow-xl border-2 border-gray-200 border-opacity-50 bg-opacity-60 backdrop-blur-md gap-10 rounded-md grid grid-cols-5">
            ...
            <div className="h-full flex col-span-2 flex-col justify-between">
                <div className="flex flex-col gap-3.5">
                    ...
                    <a href="/project" className="font-dmsans text-black text-lg font-bold flex gap-0.5 items-center select-none group">read more<img className="transition-all duration-300 w-8 group-hover:-translate-y-1 group-hover:translate-x-1 grayscale group-hover:grayscale-0" src={link} alt="" /></a>
                    <div className="flex items-center gap-6">
                        <button className="w-12 h-12 bg-gray-300 shadow-md bg-opacity-50 backdrop-blur-lg rounded-full flex justify-center items-center group"><img className="w-7/12 transition-all duration-300 grayscale group-hover:grayscale-0" src={like} alt="" /></button>
                        <button className="w-12 h-12 bg-gray-300 shadow-md bg-opacity-50 backdrop-blur-lg rounded-full flex justify-center items-center group hover:bg-black transition-colors duration-300 hover:bg-opacity-75"><img className="w-7/12 transition-all duration-300 grayscale -rotate-180" src={like} alt="" /></button>
                    </div>
                </div>
                <div className="flex gap-10 justify-between w-full">
                    ...
                    <div className="flex gap-7">
                        ...
                        <p className="font-dmsans text-black text-normal font-medium opacity-75 flex gap-2 items-end select-none"><img className="w-7 grayscale" src={like} alt="" />{project.likes}</p>
                    </div>
                </div>
            </div>
        </section>
