                ...
                <div className="flex justify-center items-center w-full bg-white">
                    <div className="flex justify-between items-center w-10/12 gap-5 lg:gap-0 lg:w-11/12 h-20 bg-white">
                        <Link to={"/home"} className="group flex justify-center items-center gap-4">
                            ...
                            <h1 className='font-montserrat text-black group-hover:bg-gradient-to-r from-primary to-secondary hidden lg:inline-block group-hover:text-transparent bg-clip-text text-2xl xl:text-3xl font-bold transition-all duration-500' >fundflow.</h1>
                        </Link>
                        <div className="hidden lg:flex xl:gap-12 gap-5">
