        ...
        <div className="flex flex-col group/project" ref={optionsRef}>
            ...
            <div className="flex items-center justify-between gap-3 pt-3">
                ...
                <div className="flex flex-col gap-1 text-right">
                    <p className="font-dmsans text-black text-opacity-75 text-sm font-semibold cursor-pointer flex items-center justify-end gap-1"><img className="w-5 opacity-75" src={like} alt="Like Icon" /> {likes}</p>
