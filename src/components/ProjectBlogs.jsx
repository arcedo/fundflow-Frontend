...
function BlogEntry({ blog, index }) {
    ...
    return (
        <div style={{ animationDelay: `${delay}s` }} className="fade-in w-8/12 cursor-pointer p-6 flex flex-col gap-4 rounded-lg shadow-md border-2 border-gray-300 border-opacity-20 hover:bg-gray-400 hover:bg-opacity-30 transition-all duration-200">
