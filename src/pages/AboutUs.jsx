        ...
        <div className="w-full bg-white min-h-screen overflow-hidden h-fit flex flex-col gap-16">
            ...
            <div className="flex flex-col items-center justify-center gap-10 mt-30">
                <div className="relative w-full bg-black" style={{ height: `${window.innerWidth < 640 ? '30vh' : '60vh'}` }}>
                    <div className="absolute inset-0 flex flex-col justify-center w-5/12 mx-auto pt-24 px-8 fade-in">
                ...
                <div className="flex flex-col justify-center items-center w-5/12 gap-12 pb-20">
                    <div className="relative w-full">
                        <div className="absolute -bottom-20 flex flex-col p-8 gap-4 bg-white rounded-xl shadow-xl border fade-in border-gray-200 border-opacity-60 bg-opacity-80 backdrop-blur-2xl">
                    ...
                    <div className="flex flex-col gap-1 pt-20 px-8 fade-in">
