    ...
    return (
        <div className="w-full bg-white min-h-screen overflow-hidden h-fit flex flex-col gap-10">
            ...
            <div className="flex flex-col items-center justify-center gap-10 mt-28" style={{ height: `${window.innerWidth < 640 ? '35vh' : '60vh'}` }}>
                <h2 className="font-dmsans font-bold text-7xl text-black bg-gradient-to-r from-primary to-secondary inline-block text-transparent bg-clip-text">://404</h2>
                <p className="font-dmsans font-bold text-3xl text-black">Page not found</p>
