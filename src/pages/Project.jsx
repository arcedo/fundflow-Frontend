    ...
    return (
        <div className="w-full bg-gray-200 min-h-screen overflow-hidden h-fit flex flex-col gap-10">
            ...
            <div className="relative flex flex-col items-center justify-center gap-10 mt-20">
                ...
                {!editMode && project && project.userUrl === userData.userUrl ? <Link to={`/projects/${project.projectUrl}/edit`} className="fixed bottom-0 right-0 m-8 z-40 bg-gradient-to-r from-primary to-secondary rounded-full group">
